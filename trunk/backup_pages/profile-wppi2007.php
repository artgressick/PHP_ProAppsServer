<?php
	...
	//WWPI 2007 used old WWPI 2006 page to build the new one.
  ...
  if (!(strpos($badge,"^") === false)) {
    $tokens     = explode("^", $badge, 30 /* limiting the number of tokens to 20 */);
	$id_Badge   = ($tokens[0] ? stripslashes($tokens[0]) : ""); //The first field on GV expo is 1 not 0
    $first_name = ($tokens[2] ? stripslashes($tokens[2]) : "");
	$last_name  = ($tokens[3] ? stripslashes($tokens[3]) : "");
    $company  	= ($tokens[7] ? stripslashes($tokens[7]) : "");
    $address1   = ($tokens[9] ? stripslashes($tokens[9]) : "");
    $address2   = ($tokens[10] ? stripslashes($tokens[10]) : "");
	$city		= ($tokens[13] ? stripslashes($tokens[13]) : "");
	$state		= ($tokens[14] ? stripslashes($tokens[14]) : "");
	$zip		= ($tokens[15] ? stripslashes($tokens[15]) : "");
	$country	= ($tokens[16] ? stripslashes($tokens[16]) : "");
	$phone		= ($tokens[18] ? stripslashes($tokens[18]) : "");
	$fax		= ($tokens[19] ? stripslashes($tokens[19]) : "");
	$email		= ($tokens[23] ? stripslashes($tokens[23]) : "");
  ...
  <tr>
    ...
    <td bgcolor="#ffffff"><form name="form1" method="post" action="insertprofile.php">
      ...
      Training</font></td>
				...
				<tr>
                  <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong><font color="#0000FF">3</font>. Which of the following formats do you work with?</strong> (Choose all that apply.) </font></td>
                </tr>
                <tr>
                  <td><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
                  <td><table width="100%"  border="0" cellspacing="0" cellpadding="3">
                    <tr>
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">
                        <input name="Q3a" type="checkbox" id="Q3a" value="Medium Format digital">
                        Medium Format digital 
                      </font></td>
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">
                        <input name="Q3d" type="checkbox" id="Q3d" value="Film SLR">
                        Film SLR                       </font></td>
                    </tr>
                    <tr>
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">
                        <input name="Q3b" type="checkbox" id="Q3b" value="Medium Format film">
                        Medium Format film 
                      </font></td>
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">
                        <input name="Q3e" type="checkbox" id="Q3e" value="Small Format">
                        Small Format, non-SLR (Consumer point &amp; shoot) </font></td>
                    </tr>
                    <tr>
                      <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif">
                        <input name="Q3c" type="checkbox" id="Q3c" value="Digital SLR">
                        Digital SLR
                      </font></td>
                      </tr>
                  </table></td>
				...
				<tr>
                  <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong><font color="#0000FF">4</font>. Where do you primarly purchase your Photgraphy equipment?</strong> (Please select one.) TAKE THIS OUT </font></td>
                </tr>
                <tr>
                  <td><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
                  <td><table width="100%"  border="0" cellspacing="0" cellpadding="3">
                    <tr>
                      <td>
                          <select name="Q4" size="1" id="Q4">
                            <option value="0" selected>Please choose</option>
                            <option value="Photo Dealer">Professional Phot Dealer (Calumet or Adorama)</option>
                            <option value="Consumer">Consumer Electronic Retailer (Best Buy, Circuit City, Fry's)</option>
                            <option value="Apple">Apple</option>
                            <option value="Online">Other (Online or Cataloger)</option>
                              </select>                      </td>
                    </tr>
                  </table></td>
                </tr>
                ...
                <tr>
                  ...
                  <td width="100%"><table width="100%"  border="0" cellspacing="0" cellpadding="3">
                    <tr>
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">
                        <input name="Q5a" type="checkbox" id="Q5a" value="Pro Hardware">
                        Pro Hardware 
                      </font></td>
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">
                        <input name="Q5d" type="checkbox" id="Q5d" value="Consumer Software">
                        Consumer Software                       </font></td>
                    </tr>
                    <tr>
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">
                        <input name="Q5b" type="checkbox" id="Q5b" value="Aperture">
                        Aperture
                      </font></td>
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">
                        <input name="Q5e" type="checkbox" id="Q5e" value="Xseries">
                        Xserve or Xserve RAID </font></td>
                    </tr>
                    <tr>
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">
                        <input name="Q5c" type="checkbox" id="Q5c" value="Consumer Hardware">
                        Consumer Hardware 
                      </font></td>
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">
                        <input name="Q5f" type="checkbox" id="Q5f" value="All of above">
                        All of the above </font></td>
                    </tr>
                  </table></td>
                </tr>
				<tr>
...
Yes</font>                          </td>
        ...
        <tr>
          <td><input name="Submit" type="submit" value="Register and Proceed to Classes"> <input type="hidden" name="badge" value="<?=$badge?>"
