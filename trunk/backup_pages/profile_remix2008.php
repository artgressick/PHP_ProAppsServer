          ...
          <td><table width="100%"  border="0" cellspacing="0" cellpadding="3">
            ...
            <tr>
              <td colspan="2"><table width="100%"  border="0" cellspacing="0" cellpadding="3">
                <tr>
                  <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong>Would you like to find out more information about the services offered by the Aperture Users Professional Network?</strong></font></td>
                </tr>
                <tr>
