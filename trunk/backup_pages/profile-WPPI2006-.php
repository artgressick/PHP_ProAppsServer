  ...
  <tr>
    ...
    <td bgcolor="#ffffff"><form name="form1" method="post" action="insertprofile.php">
      ...
      Training</font></td>
				...
				<tr>
                  <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong><font color="#0000FF">4</font>. Where do you primarly purchase your Photgraphy equipment?</strong> (Please select one.) </font></td>
                </tr>
                <tr>
                  <td><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
                  <td><table width="100%"  border="0" cellspacing="0" cellpadding="3">
