    ...
    <td bgcolor="#ffffff"><form name="form1" method="post" action="insertprofile.php">
          ...
          <td><table width="100%"  border="0" cellspacing="0" cellpadding="3">
            ...
            <tr>
              <td colspan="2"><table width="100%"  border="0" cellspacing="0" cellpadding="3">
                <tr>
                  <td colspan="2"><font color="#0000FF" size="1" face="Arial, Helvetica, sans-serif"><strong>1</strong></font><strong><font size="1" face="Arial, Helvetica, sans-serif">. Would you like to receive information from Apple?</font></strong><font size="1" face="Arial, Helvetica, sans-serif"> (Choose all that apply.) </font></td>
                </tr>
                <tr>
                  ...
                  <td width="100%"><table width="100%"  border="0" cellspacing="0" cellpadding="3">
                    <tr>
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">
                        <input name="Q1a" type="checkbox" id="Q1a" value="All">
      All</font></td>
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">
      ...
      Support</font></td>
                    ...
                    <tr>
                      ...
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">
                        <input name="Q1e" type="checkbox" id="Q1e" value="None">
      None</font></td>
                    </tr>
                    <tr>
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">
      ...
      Training</font></td>
                ...
                <tr>
                  <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong><font color="#0000FF">2</font>. What is your Organization Size?</strong> (Please select one.) </font></td>
                </tr>
                <tr>
                  <td><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
                  <td><table width="100%"  border="0" cellspacing="0" cellpadding="3">
                ...
                <tr>
                  <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong><font color="#0000FF">3</font>. What Type of organization best describes yours?</strong> (Please select one.) </font></td>
                </tr>
                <tr>
                  <td><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
                  <td><table width="100%"  border="0" cellspacing="0" cellpadding="3">
                      <tr>
                        <td>
                            <select name="chrOrgType" size="1" id="chrOrgType">
                              ...
                              <option value="Edu Staff/Faculty">Educational Staff or Faculty</option>
                ...
                <tr>
                  <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong><font color="#0000FF">4</font>. From Whom do you primarily purchase Apple Prodcts?</strong> (Please select one.) </font></td>
                </tr>
                <tr>
                  <td><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
                  <td><table width="100%"  border="0" cellspacing="0" cellpadding="3">
                    <tr>
                      <td>
                          <select name="Q5" size="1" id="Q5">
                            <option value="0" selected>Please choose</option>
                            <option value="Windows user/no Apple">Windows User, I haven't purchased Apple</option>
                            <option value="Apple Retail/Online">Apple Online or Apple Retail Store</option>
                            <option value="Other Retail">Other Retail Establishment</option>
                            <option value="Apple Direct">Apple Direct (My Apple Account Rep)</option>
                ...
                <tr>
                  <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong><font color="#0000FF">5</font>. Is this a Hot Lead/Contact Now?</strong> (Please select one.) </font></td>
                </tr>
                <tr>
                  <td><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
                  <td><table width="100%"  border="0" cellspacing="0" cellpadding="3">
