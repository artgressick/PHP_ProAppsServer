          ...
          <td><table width="100%"  border="0" cellspacing="0" cellpadding="3">
            ...
            <tr>
              <td colspan="2"><table width="100%"  border="0" cellspacing="0" cellpadding="3">
                <tr>
                  <td colspan="2"><font color="#0000FF" size="1" face="Arial, Helvetica, sans-serif"><strong>1</strong></font><strong><font size="1" face="Arial, Helvetica, sans-serif">. Contact me about:</font></strong><font size="1" face="Arial, Helvetica, sans-serif"> (Please select all that apply.) </font></td>
                </tr>
                <tr>
                  ...
                  <td width="100%"><table width="100%"  border="0" cellspacing="0" cellpadding="3">
                    ...
                    <tr>
                      ...
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">
                        <input name="Q1e" type="checkbox" id="Q1e" value="All">
                ...
                <tr>
                  <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong><font color="#0000FF">2</font>. Type of organization?</strong> (Please select one.) </font></td>
                </tr>
                <tr>
                  <td><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
                  <td><table width="100%"  border="0" cellspacing="0" cellpadding="3">
                      ...
                      <tr>
                        <td>
                            <select name="chrOrgSize" size="1" id="chrOrgSize">
                              ...
                              <option value="21 to 49">21 to 49</option>
                ...
                <tr>
                  ...
                  <td><table width="100%"  border="0" cellspacing="0" cellpadding="3">
                    <tr>
                      <td><select name="Q1a" size="1" id="Q1a">
                          <option value="0" selected>Please choose</option>
                          <option value="Photo VAR">Apple Photo VAR</option>
                          <option value="Online Store">Apple Retail or Apple Online Store</option>
                          <option value="Direct Sales">Apple Direct Sales</option>
                          <option value="Other Retailer">All Other Retailers</option>
                          <option value="Windows User">No current relationship. Windows User Only</option>
                          <option value="Apple reseller">I am an Apple reseller</option>
                                              </select>
                      </td>
                    </tr>
                  </table></td>
                ...
                <tr>
                  <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong><font color="#0000FF">5</font>. I am interested in:</strong> (Please select one.) </font></td>
                </tr>
                <tr>
                  <td><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
                  <td><table width="100%"  border="0" cellspacing="0" cellpadding="3">
                    <tr>
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">
                        <input name="Q2a" type="checkbox" id="Q2a" value="Apple Software">
                        Apple Software </font></td>
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">
                        <input name="Q2e" type="checkbox" id="Q2e" value="Apple Displays">
                        Apple Displays                       </font></td>
                    </tr>
                    <tr>
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">
                        <input name="Q2b" type="checkbox" id="Q2b" value="Mac OS X">
                        Mac OS X 
                      </font></td>
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">
                        <input name="Q2f" type="checkbox" id="Q2f" value="All">
                        Xserve or Xserve RAID 
                      </font></td>
                    </tr>
                    <tr>
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">
                        <input name="Q2c" type="checkbox" id="Q2c" value="Power Mac">
                        PowerMac
                      </font></td>
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">
                      <input name="Q2g" type="checkbox" id="Q2g" value="All items">
                      All Apple Hardware and Software                   </font></td>
                    </tr>
					<tr>
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">
                        <input name="Q2d" type="checkbox" id="Q2d" value="PowerBook">
                        PowerBook
                      </font></td>
                      <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp; </font></td>
                    </tr>
                ...
                <tr>
                  <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong><font color="#0000FF">6</font>. My primary photography interest/business is:</strong> (Please select one.) </font></td>
                </tr>
                <tr>
                  <td><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
                  <td><table width="100%"  border="0" cellspacing="0" cellpadding="3">
                    <tr>
                      <td><select name="Q5" size="1" id="Q5">
                          <option value="0" selected>Please choose</option>
                          <option value="Wedding and Events">Wedding and Event photography</option>
                          <option value="Commercial">Commercial photography</option>
                          <option value="Photojournalism">Photojournalism or Editorial</option>
                          <option value="Nature or Wildlife">Nature or Wildlife</option>
                ...
                <tr>
                  <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong><font color="#0000FF">7</font>. Contact me now/Hot Lead</strong> (Please select one.) </font></td>
                </tr>
                <tr>
                  <td><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
                  <td><table width="100%"  border="0" cellspacing="0" cellpadding="3">
